...
(function (root, factory) {
  ...
  (function () {
    ...
    (function () {
      ...
      Keyword.prototype.call = function(_, x) {
        return x.get(this);
      }
    })();
    ...
    (function () {
      ...
      Symbol.prototype.call = function(_, x) {
        return x.get(this);
      };
    })();
    ...
    (function () {
      var MethodCall = Colls.MethodCall = function (sym) {
        this.sym = sym;
      };

      ['method-call?'].forEach(function (quality) {
        MethodCall.prototype[m(quality)] = true;
      });

      MethodCall.prototype.printString = function () {
        return "." + this.sym.printString();
      };
    })();

    def('--method-call', function(sym) {
      return new Colls.MethodCall(sym);
    });

    /* FieldAccess */

    (function () {
      var FieldAccess = Colls.FieldAccess = function (sym) {
        this.sym = sym;
      };

      ['field-access?'].forEach(function (quality) {
        FieldAccess.prototype[m(quality)] = true;
      });

      FieldAccess.prototype.printString = function () {
        return ".-" + this.sym.printString();
      };
    })();

    def('--field-access', function(sym) {
      return new Colls.FieldAccess(sym);
    });
    ...
    def('assoc', function (coll) {
      ...
      if (coll) {
        ...
        return lookup('hash-map').apply(coll, args);
      }
    });
