...
module Shin
  ...
  class Translator
    ...
    DEFN_PATTERN       = ":meta? :sym :str? [:expr*] :expr*".freeze
    DEFN_MULTI_PATTERN = ":meta? :sym :str? :list+".freeze
