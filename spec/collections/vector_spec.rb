...
RSpec.describe "Language", "vector" do
  ...
  it "has working rest" do
    expect(%Q{ (print (pr-str (rest [1 2 3]))) }).to have_output("(2 3)")
  end
  ...
  %w(vector coll sequential associative counted indexed reduceable seqable reversible).each do |property|
